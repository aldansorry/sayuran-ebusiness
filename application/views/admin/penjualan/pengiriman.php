...
<section class="p-t-20">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="title-5 m-b-35">Selesai</h3>
                <div class="table-responsive table-responsive-data2">
                    <table id="data-table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php foreach ($this->db->select('penjualan.*,pengguna.alamat pengguna_alamat,pengguna.alamatNote pengguna_alamatNote,pengguna.kecamatan pengguna_kecamatan')->join('pengguna','penjualan.fk_pengguna=pengguna.id')->where('status', 3)->get('penjualan')->result() as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('Penjualan/set_pengiriman/' . $value->id) ?>" class="btn btn-sm btn-success">Kirim</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
