            ...
            <div class="section__content section__content--p35">
                <div class="header3-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <img src="<?php echo base_url('cooladmin/') ?>images/icon/logo-white.png" alt="CoolAdmin" />
                        </a>
                    </div>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="header3-sub-list list-unstyled">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url('ProdukDetail') ?>">Produk Detail</a>
                                    </li>
                                    <li>
