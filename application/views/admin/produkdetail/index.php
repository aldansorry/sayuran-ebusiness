...
<section class="p-t-20">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="title-5 m-b-35">Produk Detail</h3>
                <div class="table-data__tool">
                    <div class="table-data__tool-left">
                        <div class="rs-select2--light rs-select2--md">
                            <select class="form-control" name="property" id="select-produk">
                ...
                <div class="table-responsive table-responsive-data2">
                    <table id="data-table" class="table table-striped table-bordered" style="width:100%;">
                        ...
                        <tbody>
                            <?php foreach ($data_produk_detail as $key => $value) : ?>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        $('#select-produk').val('<?php echo $this->session->userdata('produkdetail_id') ?>')
        $('#select-produk').change(function(){
            let val = $(this).val();
            window.location.href = "<?php echo base_url($cname.'/set_produk/') ?>"+val;
        });
    });
</script>